...
export default function Headers() {
  ...
  return (
    <header className="absolute xl:px-24 inset-x-0 top-0 z-50">
      <nav
        aria-label="Global"
      ...
      >
        ...
        <div className="hidden lg:flex font-poppins lg:gap-x-12">
          {navigation.map((item) => (
            <a
              key={item.name}
              href={item.href}
        ...
        <div className="hidden  font-poppins lg:flex lg:flex-1 lg:justify-end">
