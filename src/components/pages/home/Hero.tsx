  ...
  return (
    <div className="">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2"></div>
        <div className="mx-auto max-w-2xl font-sora py-32 sm:py-48 lg:py-56">
